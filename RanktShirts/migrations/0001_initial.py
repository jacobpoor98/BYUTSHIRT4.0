    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primarycolor', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='RanktShirts.primarycolor', to_field='color_name', verbose_name='Primary Color')),
